  ...
  <div class="filter-panel">
    <el-card shadow="hover" class="panel-card">
      ...
      <el-form label-position="top" size="default">
        ...
        <el-form-item label="补货频次">
          <el-select
            v-model="localFilters.replenishFreq"
            placeholder="全部"
            clearable
            @change="handleChange"
          >
            <el-option label="高频(>=4次/月)" value="high" />
            <el-option label="中频(2-4次/月)" value="medium" />
            <el-option label="低频(<2次/月)" value="low" />
          </el-select>
        </el-form-item>
